...
fun Thumbnail.toThumbnail(): echo.music.iad1tya.domain.data.model.searchResult.songs.Thumbnail =
    echo.music.iad1tya.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<echo.music.iad1tya.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<echo.music.iad1tya.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
